...
pipeline {
    ...
    stages {
        ...
        stage('Checkout Target Repository') {
            steps {
                ...
                dir('target') {
                    ...
                    git 'https://github.com/omkargaikwad9/agentic-sdlc.git'
        ...
        stage('Test Repository Tools') {
            steps {

                bat '''
                    python -m agent.test_repository_tools target
                '''
